...
namespace TrashCollector.Controllers
{
    public class PickUpsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.PickUps.Include(p => p.customers).Include(p => p.employee);
        ...
        public async Task<IActionResult> Create([Bind("Id,customersId,employeesId,customerTrashWasNotCollected,customerRecyclingWasNotCollected")] PickUp pickUp)
        {
            ...
            ViewData["customersId"] = new SelectList(_context.Customers, "Id", "Id", pickUp.customersId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,customersId,employeesId,customerTrashWasNotCollected,customerRecyclingWasNotCollected")] PickUp pickUp)
        {
            if (id != pickUp.Id)
            {
                return NotFound();
